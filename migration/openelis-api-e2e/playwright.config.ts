...
export default defineConfig({
  ...
  projects: [
    ...
    // jar. p0-auth.spec.ts drives its own anonymous contexts and ignores it.
    {
      ...
      testMatch:
        /(readonly[\\/](p0-auth|p0-authz|a1-server-time|a2-static-reads|b1-testcatalog|b2-organization|b2-provider|c1-patient-reads|c2-sample-order-reads|c2-sample-form-loads|c3-result-reads|e2-editor-reads)|mutating[\\/](b2-organization-sitecode|c1-patient-edge-cases|e1-config-crud|e1-config-parity-gaps|e2-uom-writes|e2-rename-writes|e2-create-writes|e2-panel-create|e2-order-writes|e2-activation-writes|e2-assign-writes|e2-selectlist-writes|e2-testadd-writes|e2-testmodify-writes|e2-editor-section-writes|e2-editor-test-writes))\.spec\.ts/,
