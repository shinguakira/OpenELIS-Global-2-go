...
export default defineConfig({
  ...
  projects: [
    ...
    // jar. p0-auth.spec.ts drives its own anonymous contexts and ignores it.
    {
      ...
      testMatch:
        /(readonly[\\/](p0-auth|p0-authz|a1-server-time|a2-static-reads|b2-organization|b2-provider|c1-patient-reads|c2-sample-order-reads)|mutating[\\/](b2-organization-sitecode|c1-patient-edge-cases))\.spec\.ts/,
