-- source: liquibase liquibase/2.3.x.x/new_tests.xml::55::rossumg
-- +goose Up
...
INSERT into clinlims.type_of_sample( id, description, domain, lastupdated, local_abbrev, is_active, sort_order, name_localization_id, display_key)
            ...
            'Sample.type.Sputum') ON CONFLICT DO NOTHING;
-- +goose StatementEnd

-- +goose Down
-- TODO: no safe auto-generated rollback for this changeset.
-- Liquibase source: liquibase/2.3.x.x/new_tests.xml::55::rossumg
