-- source: liquibase liquibase/2.3.x.x/accession_validation_range.xml::1::rossumg
-- +goose Up
-- +goose StatementBegin
-- Insert in Validation by search by accession range
INSERT INTO clinlims.menu(id, parent_id, presentation_order, element_id,
            ...
            'tooltip.accession.validation.range',default,default) ON CONFLICT DO NOTHING;
-- +goose StatementEnd

-- +goose Down
-- TODO: no safe auto-generated rollback for this changeset.
-- Liquibase source: liquibase/2.3.x.x/accession_validation_range.xml::1::rossumg
