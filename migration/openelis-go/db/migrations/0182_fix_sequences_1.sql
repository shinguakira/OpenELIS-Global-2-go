-- source: liquibase liquibase/2.6.x.x/fix_sequences.xml::1::csteele
-- +goose Up
-- +goose StatementBegin
-- Set all sequences to the max value that their tables are currently at
...
-- Liquibase source: liquibase/2.6.x.x/fix_sequences.xml::1::csteele
