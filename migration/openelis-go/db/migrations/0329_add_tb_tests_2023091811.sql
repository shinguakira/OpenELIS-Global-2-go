-- source: liquibase liquibase/2.7.x.x/add_tb_tests.xml::2023091811::CIV developer Group
-- +goose Up
-- +goose StatementBegin
INSERT into clinlims.sampletype_test(id, sample_type_id, test_id,is_panel)
            VALUES
            (nextval('sample_type_test_seq'),(select id from type_of_sample where description = 'Selles' limit 1),
...
-- Liquibase source: liquibase/2.7.x.x/add_tb_tests.xml::2023091811::CIV developer Group
