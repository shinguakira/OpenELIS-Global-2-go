-- source: liquibase liquibase/2.7.x.x/add_tb_tests.xml::2023091821::CIV developer Group
-- +goose Up
...
INSERT INTO
            ...
            (nextval('test_result_seq'), (select id from test where description = 'Rifampicine'),null,null,'D',
...
-- Liquibase source: liquibase/2.7.x.x/add_tb_tests.xml::2023091821::CIV developer Group
